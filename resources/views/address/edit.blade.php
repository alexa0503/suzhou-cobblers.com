    ...
    <div class="row">
        <div class="panel panel-default toggle panelMove panelClose panelRefresh">
            ...
            <div class="panel-body">
                ...
                {{ Form::open(array('route' => ['address.update',$address->id], 'class'=>'form-horizontal', 'method'=>'PUT', 'id'=>'form')) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <textarea class="form-control" rows="2" name="detailed_address">{{$address->detailed_address}}</textarea>
                            <label class="help-block" for=""></label>
                        </div>
                    </div>
                    <!-- End .form-group  -->
                        ...
                        <div class="col-lg-10 col-md-9">
                            <div class="row">
                                <div class="col-xs-8 col-lg-4 col-md-4">
                                    <input class="form-control" placeholder="{{trans('messages.first_name')}}" type="text" name="first_name" value="{{$address->first_name}}" />
                                    <label class="help-block" for=""></label>
                                </div>
                                <div class="col-xs-4 col-lg-2 col-md-2">
                                    <input class="form-control" placeholder="{{trans('messages.last_name')}}" type="text" name="last_name" value="{{$address->last_name}}" />
                                    <label class="help-block" for=""></label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10 col-md-9">
                            <input class="form-control" type="text" name="phone_number" value="{{$address->phone_number}}">
                            <label class="help-block" for=""></label>
                        </div>
                    </div>
                    <!-- End .form-group  -->
