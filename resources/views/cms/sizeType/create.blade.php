                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body pt0 pb0">
                                ...
                                <!-- End .form-group  -->
                                <div class="form-group">
                                    <label for="text" class="col-lg-2 col-md-3 control-label">尺码规格[输入null则为无尺码，多个尺码以,分开]</label>
                                    <div class="col-lg-10 col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-md-9">
                                        <textarea name="zh_cn_desc" class="form-control article-ckeditor"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10 col-md-9">
                                        <textarea name="en_desc" class="form-control article-ckeditor"></textarea>
