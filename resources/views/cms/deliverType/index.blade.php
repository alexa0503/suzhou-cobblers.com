                            ...
                            <div class="panel-body">
                                ...
                                <table id="basic-datatables" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $type->locale }}</td>
                                        <td>
                                            <a href="{{route('admin.deliver.type.edit',['id'=>$type->id])}}" class="btn btn-xs btn-default" style="margin-left:10px;margin-right:10px;">编辑</a>
                                            <a href="{{route('admin.deliver.type.destroy',['id'=>$type->id])}}" class="btn btn-xs btn-warning delete">删除</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
